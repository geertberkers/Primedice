...
public class ProvablyFairFragment extends Fragment {
    ...
    private void setInformation() {
        txtClientSeed.setText(activity.getUser().client);
        txtServeSeedHashed.setText(activity.getUser().server);
        txtBetsMade.setText(String.valueOf(activity.getUser().nonce));
        txtPreviousClientSeed.setText(activity.getUser().previous_client);
        txtPreviousServerSeedRevealed.setText(activity.getUser().previous_server);
        txtPreviousServerSeedHashed.setText(activity.getUser().previous_server_hashed);
    }
            ...
            public void onClick(View v) {
                ...
                alertDialog.setPositiveButton("SET NEW SEED", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        try {
                            ChangeSeedTask changeSeedTask = new ChangeSeedTask();
                            result = changeSeedTask.execute((changeSeedURL + activity.getAccess_token()), newClientSeed).get();
